...
;
; Ultima 5 Upgrade wrapper program used to load drivers and launch the game.
...
u5			    db	"ULTIMA.EXE",0
u5_vga		    db	0x02," V",0x0d,0
u5_ega		    db	0x03," E",0x0d,0
file_error	    db	"Error reading U5.CFG",0x0a,0x0d,"$"
midpak_error	db	"Error loading MIDPAK MIDI Driver",0x0a,0x0d,"$"
launch_error	db	"Error launching Ultima V",0x0a,0x0d,"$"
...
GRAPHIC_MODE:
  ...
  ; set dx = offset of u5ega params
  mov dx,u5_ega
  jmp LAUNCH_PROGRAM

VGA:
  ; set dx = offset of u5vga params
  mov dx,u5_vga
